...
def main(global_config, **settings):
    ...
    config.add_route('show_item', '{item_id}/show_item')
    config.add_route('add_project_item', '{pname}/{item_type}/add_project_item')
    config.add_route('contact_item', '{pname}/contact_item')
    config.add_route('contact_details', '{pname}/{cname}/contact_details')
    ...
    config.add_route('inputs/new', '{item_id}/inputs/new')
    config.add_route('inputs/manage', '{item_id}/{input_id}/inputs/manage')
    config.add_route('inputs/delete', '{pname}/{if_id}/inputs/delete')
    config.add_route('show_input', '{p_id}/{input_id}/show_input')
