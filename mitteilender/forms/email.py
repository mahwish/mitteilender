...
class EmailForm(Form):
    ...
    display_order = TextField('Display order', [validators.required("Subject cannot be empty")])
    parent_item = TextField('Parent Item', [validators.required("Subject cannot be empty")])
