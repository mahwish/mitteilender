...
<head>
  ...
  <!--[if lte IE 6]>
  <link rel="stylesheet" href="${request.static_url('mitteilender:static/ie6.css')}" type="text/css" media="screen" charset="utf-8" />
  <![endif]-->
...
<%def name="header()">
  <div id="top-small">
    <img src="${request.static_url('mitteilender:static/pyck-small.png')}"  alt="pyck"/>
    ${self.main_menu()}
  </div>
</%def>
