...
<%def name="header()">
  <div id="top" style="text-align: center">
    <br /><br />
    <img src="${request.static_url('designer:static/mitti1.png')}"  alt="pyck"/>
  </div>
</%def>
...
<%def name="main_menu()"></%def>
    ...
    <div id="middle">
      <div class="middle align-center">
        <p><font color="teal"><b>
          <a href="${request.route_url('new')}"><font color="teal"><b>New Project</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp|
